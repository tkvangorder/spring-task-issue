...
---- 
include::./src/main/resources/application.yml[lines=26..27, source]
----
...
---- 
include::./src/main/java/com/example/demo/PrometheusPushFixConfiguration.java[lines=41, source, java]
----
...
---- 
include::./src/main/java/com/example/demo/PrometheusPushGatewayManagerFix.java[lines=24..27, source, java]
----
